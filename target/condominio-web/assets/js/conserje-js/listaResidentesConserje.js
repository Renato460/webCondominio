...
function setTabla(){
    $('#cuerpo').load("../conserje/views/tablaResidentes.html", function () {
        ...
        tabaResidentes =$('#tablaResidentes').DataTable({
            ...
            "columns":[
                ...
                {"defaultContent": "<div class='btn-group-sm' role='group'><button type='button' class='btn btn-info btnBuscar fs-4' title='Información Multas'><i class='fas fa-search imgMostrar'></i></button></div>"}
            ]
        });
    });
};